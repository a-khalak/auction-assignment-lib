...
public:
  ...
  template <class TwoD>
  inline generic_dense2D(const TwoD& x, band_type bw, banded_tag)
    : ld_(x.ld_),
      data_(x.data_),
      starts(x.starts),
      offset(x.offset, bw) { }
...
// VC++ doesn't like this
  ...
  //: banded view constructor
  template <class TwoD>
  inline dense2D(const TwoD& x, band_type bw, banded_tag) : super(x, bw, banded_tag()) { }
...
// VC++ doesn't like this
  ...
  */
  ...
  //: banded view constructor
  template <class TwoD>
  inline external2D(const TwoD& x, band_type bw, banded_tag) : super(x, bw, banded_tag()) { }
