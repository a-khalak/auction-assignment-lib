...
public:
  ...
  inline matrix_implementation(const Mat& x, const Scalar& y, do_scaled) 
  ...
  inline matrix_implementation(const Matrix& x, band_type bw)
...
public:
  ...
  template <class Mat, class Scalar>
  inline row_matrix(const Mat& x, const Scalar& y, do_scaled s) 
    : Base(x, y, s) { }
...
public:
  ...
  //: scaled
  template <class Mat, class Scalar>
  inline column_matrix(const Mat& x, const Scalar& y, do_scaled s) 
    : Base(x, y, s) { }
...
public:
  ...
  template <class Mat, class Scalar>
  inline diagonal_matrix(const Mat& x, const Scalar& y, do_scaled s) 
    : Base(x, y, s) { }
...
public:
  ...
  //: scaled(A)
  template <class Mat, class Scalar>
  inline triangle_matrix(const Mat& x, const Scalar& y, do_scaled s) 
    : Base(x, y, s) { }
...
public:
  ...
  template <class Mat, class Scalar>
  inline symmetric_matrix(const Mat& x, const Scalar& y, do_scaled s) 
    : Base(x, y, s) { }
